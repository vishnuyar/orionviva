...
const overviewActivityItems: ActivityView[] = [
  ...
  { id: "statement-gap-may-14", label: "Statement gap", exactValue: "0.00", display: "Needs attention", measure: "spending", detail: "May 14 · one page held", tone: "neutral", state: "needs_input", provenance: "Synthetic brokerage statement · pages 1–2", grade: "not_applicable", exactness: "estimated", recordIds: ["demo-record-statement-gap-may-14"], evidenceLinks: [
    { targetDocumentId: "demo-doc-fidelity-brokerage-2026-05-to-2026-07", label: "Taxable Brokerage statement", relation: "same_period", page: "pages 1–2" },
...
export const demoSnapshot: SurfaceSnapshot = {
  ...
  overview: { state: "ready", data: {
    ...
    { id: "chase-sapphire", name: "Chase Sapphire", kind: "Credit card", measure: "owed", exactValue: "1842.77", currency: "USD", display: "$1,842.77", grade: "verified", gradeLabel: "Verified", gradeDescription: "Confirmed by a person or a completed verification step.", note: "Monthly statement series", asOf: "July 31, 2026", coverage: "Chase statements, Aug 2022–Jul 2026", provenance: "Synthetic PDF · Chase card statement · page 1", evidenceLinks: [
      { targetDocumentId: "demo-doc-chase-card-2026-07", label: "Chase Sapphire card statement", relation: "same_account", page: "page 1" },
    ], state: "ready", exactness: "exact", recordIds: ["demo-record-chase-sapphire"] },
    { id: "citi-double-cash", name: "Citi Double Cash", kind: "Credit card", measure: "owed", exactValue: "620.14", currency: "USD", display: "$620.14", grade: "verified", gradeLabel: "Verified", gradeDescription: "Confirmed by a person or a completed verification step.", note: "Monthly statement series", asOf: "July 31, 2026", coverage: "Citi statements, Aug 2022–Jul 2026", provenance: "Synthetic PDF · Citi card statement · page 1", evidenceLinks: [
      { targetDocumentId: "demo-doc-citi-card-2026-07", label: "Citi Double Cash card statement", relation: "same_account", page: "page 1" },
    ], state: "ready", exactness: "reported", recordIds: ["demo-record-citi-double-cash"] },
    { id: "taxable-brokerage", name: "Taxable Brokerage", kind: "Brokerage", measure: "balance", exactValue: "18137.09", currency: "USD", display: "$18,137.09", grade: "corroborated", gradeLabel: "Corroborated", gradeDescription: "Supported by more than one source or matching record.", note: "Quarterly statements with holdings", asOf: "July 31, 2026", coverage: "Brokerage statements, Aug 2022–Jul 2026", provenance: "Synthetic PDF · brokerage statement · pages 1–2", evidenceLinks: [
      { targetDocumentId: "demo-doc-fidelity-brokerage-2026-05-to-2026-07", label: "Taxable Brokerage statement", relation: "same_account", page: "pages 1–2" },
      { targetDocumentId: "demo-doc-north-river-savings-2026-05-to-2026-07", label: "North River Savings statement", relation: "corroborates", page: "page 1" },
  ...
  review: { state: "ready", data: { queue: [
    ...
    { id: "duplicate-subscription", label: "Duplicate subscription", detail: "A fictional subscription question illustrates a decline boundary.", status: "Fictional sample", action: "", type: "Subscription", evidence: "Card statement, page 1", state: "needs_input", outcome: null, disposition: null, sample: { anatomy: "decline", evidenceLinks: [{ targetDocumentId: "demo-doc-chase-card-2026-07", label: "Chase Sapphire card statement", relation: "settles_question", page: "page 1" }] } },
    { id: "held-statement-page", label: "Held statement page", detail: "May brokerage page is still waiting for a human check.", status: "Fictional sample", action: "", type: "Document review", evidence: "Brokerage statement, pages 1–2", state: "needs_input", outcome: null, disposition: null, sample: { anatomy: "proposal", proposedValue: "Keep the fictional page held for review", evidenceLinks: [{ targetDocumentId: "demo-doc-fidelity-brokerage-2026-05-to-2026-07", label: "Taxable Brokerage statement", relation: "settles_question", page: "pages 1–2" }] } },
  ...
  ], count: 4, meta: { total: 4, tail: { count: 0, amount: "0" }, pending: { count: 0 }, invite: "Inspect the fictional question anatomy", answeredByDocument: "A fictional document may illustrate supporting evidence" } } },
  documents: { state: "ready", data: { documents: [
    { id: "demo-doc-silverline-checking-2026-07", name: "silverline-checking-2026-07.pdf", state: "Verified", phase: "verified", phaseLabel: "Verified", detail: "Synthetic corpus · 2026-07-01 to 2026-07-31", source: "Generated locally", pages: "1 page", provenance: "Synthetic PDF · checking statement · page 1", docType: "Checking statement", resolved: true, rawAvailable: true, sample: { region: "Page 1 · balance summary", contribution: "Fictional checking balance and July activity." }, evidenceLinks: [
      { targetDocumentId: "demo-doc-chase-card-2026-07", label: "Chase Sapphire card statement", relation: "same_period", page: "page 1" },
      { targetDocumentId: "demo-doc-citi-card-2026-07", label: "Citi Double Cash card statement", relation: "same_period", page: "page 1" },
    ] },
    ...
    { id: "demo-doc-chase-card-2026-07", name: "chase-card-2026-07.pdf", state: "Reading", phase: "reading", phaseLabel: "Reading", detail: "Synthetic corpus · 2026-07-01 to 2026-07-31", source: "Generated locally", pages: "1 page", provenance: "Synthetic PDF · Chase card statement · page 1", docType: "Card statement", resolved: false, rawAvailable: true, sample: { region: "Page 1 · account summary" }, evidenceLinks: [
      { targetDocumentId: "demo-doc-silverline-checking-2026-07", label: "Everyday Checking statement", relation: "same_period", page: "page 1" },
    ] },
    { id: "demo-doc-citi-card-2026-07", name: "citi-card-2026-07.pdf", state: "Parked", phase: "parked", phaseLabel: "Parked", detail: "Synthetic corpus · 2026-07-01 to 2026-07-31", source: "Generated locally", pages: "1 page", provenance: "Synthetic PDF · Citi card statement · page 1", docType: "Card statement", resolved: false, rawAvailable: true, sample: { waitReason: "This fictional sample has no supported way to continue reading it." }, evidenceLinks: [
      { targetDocumentId: "demo-doc-silverline-checking-2026-07", label: "Everyday Checking statement", relation: "same_period", page: "page 1" },
    ] },
    { id: "demo-doc-north-river-savings-2026-05-to-2026-07", name: "north-river-savings-2026-05-to-2026-07.pdf", state: "Held", phase: "held", phaseLabel: "Held for review", detail: "Synthetic corpus · quarterly statement awaiting review", source: "Generated locally", pages: "1 page", provenance: "Synthetic PDF · savings statement · page 1", docType: "Savings statement", resolved: false, rawAvailable: true, sample: { region: "Page 1 · quarterly summary", contribution: "Fictional savings balance.", waitReason: "A human decision is needed for the held statement." }, evidenceLinks: [
      { targetDocumentId: "demo-doc-silverline-checking-2026-07", label: "Everyday Checking statement", relation: "same_account", page: "page 1" },
      { targetDocumentId: "demo-doc-fidelity-brokerage-2026-05-to-2026-07", label: "Taxable Brokerage statement", relation: "corroborates", page: "pages 1–2" },
    ] },
    { id: "demo-doc-fidelity-brokerage-2026-05-to-2026-07", name: "fidelity-brokerage-2026-05-to-2026-07.pdf", state: "Waiting", phase: "queued", phaseLabel: "Waiting for a reader", detail: "Synthetic corpus · holdings page available for review", source: "Generated locally", pages: "2 pages", provenance: "Synthetic PDF · brokerage statement · pages 1–2", docType: "Brokerage statement", resolved: false, rawAvailable: true, sample: { region: "Pages 1–2 · holdings", contribution: "Fictional brokerage holdings.", waitReason: "The captured original is waiting; this screen does not start reader work." }, evidenceLinks: [
      { targetDocumentId: "demo-doc-north-river-savings-2026-05-to-2026-07", label: "North River Savings statement", relation: "corroborates", page: "page 1" },
    ] },
