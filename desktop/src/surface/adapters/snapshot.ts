import type { ActivityData, ConversationData, DocumentsData, FeatureResult, OverviewData, PlansData, SurfaceSnapshot, TrustData } from "../types";
...
export function buildLiveSnapshot(overview: FeatureResult<OverviewData>, documents: FeatureResult<DocumentsData>, conversation: FeatureResult<ConversationData>, trust: FeatureResult<TrustData>, activity: FeatureResult<ActivityData>, plans: FeatureResult<PlansData> = { state: "absent", reason: "not_read" }, disclosure: SurfaceSnapshot["disclosure"] = privateVault): SurfaceSnapshot {
  return {
    disclosure,
    overview,
    documents,
