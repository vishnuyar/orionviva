...
export type EvidenceLink = { targetDocumentId: string; label: string; relation: "same_period" | "same_account" | "settles_question" | "corroborates"; page: string };
