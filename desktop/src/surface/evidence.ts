import type { AccountView, CurrentPeriodSliceView, DocumentsData, EvidenceLink, FeatureResult, FigureGrade, FigureMeasure, FigureView, ProofPresentation, SurfaceDocument, SurfaceSnapshot, UnmeasuredAccount } from "./types";
