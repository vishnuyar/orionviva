...
function Configuration({ controls }: { controls: SettingsControls }) {
  ...
  return <section className="trust-settings" aria-labelledby="trust-settings-title">
    <h3 id="trust-settings-title">Document reading and number settings</h3><p>Saving a statement keeps an encrypted original. Reading its contents needs a model. Choose the connection yourself; this app does not choose a service or model for you. A configured service may receive document content and charge for reading.</p>
    ...
    <details className="trust-model-connection"><summary>Model connection settings</summary><p>Use the exact model name and connection details supplied by your chosen service. Review the proposed changes before confirming them.</p>
...
function TrustReady({ data, identity, lifecycle, transfer, maintenance }: { data: TrustData; identity: FeatureResult<EngineIdentity>; lifecycle: FeatureResult<UpdateLifecycleView>; transfer: TransferControls | null; settings: SettingsControls | null; maintenance: MaintenanceControls | null }) {
