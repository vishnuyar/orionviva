...
import type { FeatureResult, SurfaceMode, TrustCapabilityGroup, TrustCapabilityState, TrustData, TrustNote, TrustSampleCapability } from "../../surface/types";
...
function TrustReady({ data, mode }: { data: TrustData; mode: SurfaceMode }) {
