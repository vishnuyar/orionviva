...
export function createHostBridgeClient(transport: BridgeTransport): BridgeClient {
  ...
  return {
    ...
    readAccountLedger: (accountId, cursor, limit) => read("account_ledger", {
    ...
    assignActivityClassification: (movementIds: readonly string[], categoryId: string, subcategoryId: string) => request("viva.activity.assign_classification", { movement_ids: [...movementIds], category_id: categoryId, subcategory_id: subcategoryId }),
    ...
    addActivityTags: (movementIds: readonly string[], tagIds: readonly string[]) => request("viva.activity.add_tags", { movement_ids: [...movementIds], tag_ids: [...tagIds] }),
    removeActivityTags: (movementIds: readonly string[], tagIds: readonly string[]) => request("viva.activity.remove_tags", { movement_ids: [...movementIds], tag_ids: [...tagIds] }),
