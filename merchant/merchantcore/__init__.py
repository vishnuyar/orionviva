...
from .taxonomy import (FALLBACK_CATEGORY, FALLBACK_SUBCATEGORY,
                       PRIMARY_CATEGORIES, TAXONOMY_VERSION,
...
__all__ = [
    ...
    "Catalog", "home",
    "PRIMARY_CATEGORIES", "FALLBACK_CATEGORY", "FALLBACK_SUBCATEGORY",
    "TAXONOMY_VERSION",
