...
def handlers_for_opened_vault(
    ...
    return BridgeDispatcher({
        **reads.handlers,
        ...
        ACTIVITY_OPERATIONS["assign_classification"]: activity_actions.assign_classification,
        ...
        ACTIVITY_OPERATIONS["add_tags"]: activity_actions.add_tags,
        ACTIVITY_OPERATIONS["remove_tags"]: activity_actions.remove_tags,
