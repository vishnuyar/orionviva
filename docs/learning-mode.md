...
**Status:** Design note — **not being built now** (Vishnu, 2026-07-25); recorded so the questions stay asked · **Origin:** the first real run of the question queue, which asked two questions it had no right to ask. **Blocks it points at:** amount-split (built in v0, never used) · Asset · the free-text ruling.
