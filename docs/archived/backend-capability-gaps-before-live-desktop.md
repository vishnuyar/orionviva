...
>
> This was the capability handoff before the live desktop bridge was completed.
> Its counts, operation list, and build order are intentionally preserved as
> evidence of the earlier plan. See
> [the current gap record](../backend-capability-gaps.md) for what remains.
