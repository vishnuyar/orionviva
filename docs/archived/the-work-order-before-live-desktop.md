...
>
> This was the ordered desktop build plan. Its numbered positions are preserved
> because they explain how the live application was assembled, not because they
> describe unfinished work. See
> [UI implementation status](../user-interface-implementation-status.md) and
> [the current gap record](../backend-capability-gaps.md) for present state.
