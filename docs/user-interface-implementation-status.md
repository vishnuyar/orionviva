...
| `has-file desktop/src/features/conversation/ConversationDrawer.tsx` | Ask Viva is connected for text. There is no microphone, speech recognition, or audio playback path; the reply shape is only voice-ready. |
