...
| **AP-7** | Admission measures and enforces one exact runtime profile | enforced *(exception)* | [answer-program-and-financial-query-engine.md](answer-program-and-financial-query-engine.md) | `test_all_73_frozen_cases_derive_real_oracles_before_scoring_a_bad_result` +2 |
...
| **MON-69** | full numbers decide; colliding signal keys receive opaque ids | enforced | [account-identity-and-entity-resolution.md](account-identity-and-entity-resolution.md) | `test_different_full_numbers_with_matching_last_four_both_post_and_replay` |
...
| **MON-71** | an ambiguous document is held; its exact ruling persists and only safe signals generalize | enforced | [account-identity-and-entity-resolution.md](account-identity-and-entity-resolution.md) | `test_masked_multi_candidate_can_be_assigned_to_a_specific_account` |
| **MON-72** | an account carries an evolving identity set | enforced | [account-identity-and-entity-resolution.md](account-identity-and-entity-resolution.md) | `test_masked_account_learns_full_number_before_a_later_collision` |
...
| **PROJ-3** | a hole declares what its number is of and what set it is over | enforced | [projection-decomposition-and-the-tool-registry.md](projection-decomposition-and-the-tool-registry.md) | `test_a_hole_holding_a_magnitude_must_say_what_set_it_is_over` +1 |
...
| **PROJ-5** | a property of a figure the machine holds is placed by the machine | enforced | [projection-decomposition-and-the-tool-registry.md](projection-decomposition-and-the-tool-registry.md) | `test_a_boundary_is_said_once_inside_the_clause_that_made_it` +2 |
...
| **MER-27** | The product imports matched records as events | enforced | [merchantcore-package.md](merchantcore-package.md) | `test_upload_applies_a_reviewed_commons_alias_before_defaults` +3 |
...
| **MER-30** | The commons export is linted, and an import is only a prior | enforced | [merchantcore-package.md](merchantcore-package.md) | `test_catalog_pending_add_and_linted_export` +4 |
...
| **MER-42** | Every lookup preserves canonical and legacy keys | enforced | [merchant-catalog-and-commons.md](merchant-catalog-and-commons.md) | `test_reviewed_aliases_group_two_location_forms_under_one_merchant` +3 |
