...
**State:** enforced
**Code:** product/viva/persona/__init__.py:462 (`say`), product/viva/persona/pack-v29/ (each newer pack adds a family and copies the rest verbatim; pack-v19 was in force until a stopped job needed words, pack-v20 until a vault leaving and coming back did, and pack-v21 until a pass back over what is already held did)
