...
**4. The category taxonomy is minimal, overridable data (I5).** A small seed set (groceries, dining, transport, utilities, rent/housing, shopping, health, income, transfers, other), jurisdiction-neutral and aggressively overridable. Categories are data; a region or a person can extend them without a code change or a US-shaped table.
