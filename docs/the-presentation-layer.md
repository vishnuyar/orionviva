...
**Status:** Design spec — **decisions ruled (2026-07-25), pre-build** · **Last updated:** 2026-07-25 · **Block seeded:** the surface as a first-class layer — the ranked question queue as the page's spine, and every figure the engine knows finally visible.
